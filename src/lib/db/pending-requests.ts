...
// ═══════════════════════════════════════════════════════════════
// ชุดฟังก์ชันสำหรับเข้าถึง/จัดการคำขอสมัครใน council_join_requests
//
...
/** ข้อมูลคำขอสมัครที่ดึงมาจาก council_join_requests */
...
/**
 * ดึงคำขอสมัครทั้งหมด (เรียงตาม created_at ล่าสุดก่อน)
 *
...
/** ดึงคำขอสมัครด้วย student_id (นักเรียน) */
...
/** ดึงคำขอสมัครด้วย email (ครู/อื่นๆ) */
...
/**
 * นับจำนวนคำขอสมัครที่ยัง pending
...
/**
 * อนุมัติคำขอสมัคร — ใช้ service-role adminClient (bypass RLS)
 *
 * Steps:
...
/**
 * ปฏิเสธคำขอสมัคร — ใช้ service-role adminClient (bypass RLS)
 *
