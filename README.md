...
>
> **เวอร์ชันปัจจุบัน: v3.9.7** — Left-Rail Layout Fix (Desktop)

> ## What's new in v3.9.7

> ### 🛠 Fix — แก้เนื้อหาทับซ้อนกับแถบนำทางด้านซ้ายบน desktop
> - **อาการ**: บน desktop (≥900px) left-rail ทับเนื้อหา เพราะ `.bottom-nav` เป็น `position: fixed`
> - **วิธีแก้**: เพิ่ม `--yp-left-rail-width` variable + `padding-left` บน `.app-main` + `left` บน `.top-bar`
> - ค่า width: ≥900px = 96px, ≥1280px = 108px, ≥1536px = 120px

> ### 📄 About Page Update
> - อัปเดตเวอร์ชันเป็น 3.9.7
> - เพิ่ม changelog v3.9.7
> - เก็บ changelog v3.9.6 และเวอร์ชันก่อนหน้าไว้อ้างอิง
